...
def attack(char_name: str, char_class: str) -> str:
    """Функция считает нанесенный урон."""
    if char_class == 'warrior':
        return (f'{char_name} нанёс урон'
                f'противнику равный {5 + r(3, 5)}')
    if char_class == 'mage':
        return (f'{char_name} нанёс урон'
                f'противнику равный {5 + r(5, 10)}')
    if char_class == 'healer':
        return (f'{char_name} нанёс урон'
                f'противнику равный {5 + r(-3, -1)}')
    return (f'{char_name} не применил специальное умение')


def defence(char_name: str, char_class: str) -> str:
    """Функция рассчитывает заблокированный урон."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция описывает, примененное умение."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция описывает характеристики класса."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция предлагает выбор персонажа."""
